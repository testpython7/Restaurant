...
from apiapp.views import UserRegistrationView,UserLoginView,UserProfileView,UserChangePasswordView,SendPasswordEmailView,Restaurantadd,EmailLinkPasswordResetView,Restaurantmanuadd,UserlikeRestaurant,Userlikemenuitem,UserlikeRestaurant,Usersavemenuitem,AllRestaurant
...
router.register('allrestaurant', AllRestaurant, basename='allrestaurant')
